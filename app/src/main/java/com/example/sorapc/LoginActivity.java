...
/**
 * <summary>
 * Класс LoginActivity предоставляет функционал авторизации пользователей.
 * Поддерживает ввод учетных данных, проверку через Firebase Authentication, а также навигацию к регистрации и восстановлению пароля.
 * </summary>
 */
