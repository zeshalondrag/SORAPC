...
/**
 * Класс CheckoutActivity представляет собой активность для оформления заказа.
 *
 * Основное назначение:
 * - Отображение товаров, добавленных пользователем в корзину.
 * - Выбор способа оплаты (карта или наличные).
 * - Рассчет итоговой суммы, включая комиссию.
 * - Завершение процесса оформления заказа с обновлением базы данных.
 * - Отправка электронного чека на email пользователя.
 *
 * Основные функции:
 * - Поддержка оплаты картой с выбором доступной карты из Firebase Firestore.
 * - Расчет комиссии (1%) для оплаты картой.
 * - Обновление данных о товарах (уменьшение количества на складе, увеличение продаж).
 * - Очистка корзины после оформления заказа.
 * - Отправка HTML-сообщения на email с деталями заказа.
 *
 * Поля:
 * - checkoutList: Список товаров, добавленных в корзину.
 * - cards: Список доступных карт для оплаты.
 * - isCardPayment: Флаг, указывающий на выбранный способ оплаты (true - карта, false - наличные).
 * - selectedCard: Выбранная карта для оплаты.
 * - processedProducts: Счетчик обработанных товаров.
 ...
 *
 * Особенности:
 * - Интеграция с Firebase Firestore для работы с товарами, корзиной, заказами и картами.
 * - Использование JavaMail API для отправки электронных чеков.
 * - Обработка ошибок на каждом этапе с предоставлением обратной связи пользователю через Toast.
 * - Интеграция с Header для поддержания общего стиля приложения.
 */
