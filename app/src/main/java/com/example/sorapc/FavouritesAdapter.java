...
/**
 * Класс FavouritesAdapter представляет собой адаптер для отображения списка избранных товаров в RecyclerView.
 *
 * Основное назначение:
 * - Отображение избранных товаров и предоставление интерфейса для добавления их в корзину, изменения количества и удаления из избранного.
 *
 * Основные функции:
 * - Загрузка данных избранных товаров и синхронизация с Firebase Firestore.
 * - Поддержка добавления товаров в корзину, а также увеличения и уменьшения их количества.
 * - Удаление товаров из списка избранного.
 * - Автоматическое обновление UI при изменении данных (например, количества товара).
 *
 * Поля:
 ...
 * - cartItems: Карта товаров, добавленных в корзину, для быстрого доступа и синхронизации.
 *
 * Вложенный класс:
 * - FavouritesViewHolder: ViewHolder, содержащий ссылки на элементы интерфейса для управления избранными товарами.
 *
 * Особенности:
 * - Интеграция с Firebase Firestore для работы с товарами, избранным и корзиной.
 * - Использование библиотеки Glide для загрузки изображений товаров.
 * - Уведомление пользователя об ошибках и успешных действиях с помощью Toast сообщений.
 * - Поддержка обновления количества товаров в корзине с проверкой доступного количества на складе.
 */
