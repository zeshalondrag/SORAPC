...
/**
 * <summary>
 * Класс FavouritesAdapter используется для отображения списка избранных товаров в RecyclerView.
 * Он предоставляет пользователю возможность добавлять товары в корзину, изменять их количество и удалять из избранного.
 * </summary>
 */
