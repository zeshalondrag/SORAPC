...
/**
 * <summary>
 * Класс CartActivity представляет активность для управления корзиной пользователя.
 * Он загружает товары из Firestore, синхронизирует данные корзины с интерфейсом в реальном времени,
 * рассчитывает итоговую стоимость и предоставляет возможность перейти к оформлению заказа.
 * </summary>
 */
