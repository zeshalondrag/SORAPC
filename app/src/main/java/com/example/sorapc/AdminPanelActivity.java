...
/**
 * Класс AdminPanelActivity представляет собой активность для панели администратора.
 *
 * Основная цель этого класса — обеспечить взаимодействие с элементами интерфейса,
 * такими как кнопки и иконки, которые позволяют администратору переходить к управлению
 * продуктами, клиентами, категориями и отзывами. Также реализована кнопка возврата
 * для упрощения навигации.
 *
 * Основные функции:
 * - Обработка нажатий на кнопки для перехода к соответствующим активностям управления.
 * - Инициализация пользовательского интерфейса с использованием layout-файла.
 * - Интеграция заголовка с использованием класса Header.
 */
