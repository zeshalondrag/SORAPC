...
/**
 * <summary>
 * Класс AdminPanelActivity представляет собой активность панели администратора приложения.
 * Предоставляет интерфейс для управления продуктами, клиентами, категориями и отзывами.
 * Содержит кнопки для перехода к соответствующим разделам управления и кнопку возврата.
 * </summary>
 */
