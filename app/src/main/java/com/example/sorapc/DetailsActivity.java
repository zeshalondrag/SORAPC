...
/**
 * <summary>
 * Класс DetailsActivity предоставляет подробную информацию о товаре, включая его описание, характеристики, отзывы и наличие.
 * Реализует функционал добавления товара в корзину, покупку, управление избранным, а также написание, редактирование и удаление отзывов.
 * Интегрируется с Firebase Firestore для синхронизации данных.
 * </summary>
 */
