...
/**
 * <summary>
 * Класс ReviewAdapter адаптирует данные отзывов для отображения в RecyclerView.
 * Поддерживает режимы пользователя и администратора для управления отзывами, включая редактирование и удаление.
 * </summary>
 */
