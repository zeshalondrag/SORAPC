...
/**
 * <summary>
 * Класс ProfileActivity предоставляет полный функционал управления профилем пользователя.
 * Позволяет редактировать данные, управлять привязанными картами, просматривать избранное и историю заказов, а также удалять аккаунт.
 * Интеграция с Firebase Firestore обеспечивает работу с данными пользователя.
 * </summary>
 */
