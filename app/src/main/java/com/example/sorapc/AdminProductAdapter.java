...
/**
 * Класс AdminProductAdapter — это адаптер для отображения списка продуктов в административной панели.
 *
 * Основное назначение:
 * - Отображение данных о продуктах, включая изображение, название, артикул и цену.
 * - Обработка действий пользователя, таких как редактирование и удаление продукта.
 * - Поддержка фильтрации списка продуктов по запросу пользователя.
 *
 * Основные функции:
 * - Настройка элементов RecyclerView для отображения информации о продукте.
 * - Реализация интерфейсов для обработки событий редактирования и удаления продуктов.
 * - Фильтрация списка продуктов для поиска по названию или артикулу.
 *
 * Используемые технологии:
 * - Glide для загрузки изображений.
 * - Firebase Firestore для управления данными о продуктах.
 */
