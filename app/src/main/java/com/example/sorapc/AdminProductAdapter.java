...
/**
 * <summary>
 * Класс AdminProductAdapter предназначен для управления отображением списка продуктов
 * в административной панели. Обеспечивает функционал фильтрации, редактирования и удаления
 * продуктов с использованием RecyclerView.
 * </summary>
 */
