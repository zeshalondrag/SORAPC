...
/**
 * <summary>
 * Класс RegisterActivity предоставляет функционал для регистрации новых пользователей в приложении SORAPC.
 * Реализует валидацию введённых данных, проверку уникальности email, регистрацию через Firebase Authentication,
