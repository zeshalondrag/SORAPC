...
/**
 * <summary>
 * Класс CheckoutAdapter используется для отображения списка товаров в процессе оформления заказа.
 * Предоставляет информацию о товаре, включая изображение, название, артикул, цену и количество,
 * и используется в CheckoutActivity.
 * </summary>
 */
