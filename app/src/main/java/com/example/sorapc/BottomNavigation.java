...
/**
 * <summary>
 * Класс BottomNavigation отвечает за обработку нижней навигационной панели приложения.
 * Он обеспечивает переключение между основными экранами (Главная, Каталог, Корзина, Поддержка),
 * предотвращая лишние переходы, если пользователь уже находится на выбранном экране.
 * </summary>
 */
