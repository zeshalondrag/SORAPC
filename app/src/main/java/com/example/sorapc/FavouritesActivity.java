...
/**
 * <summary>
 * Класс FavouritesActivity используется для управления списком избранных товаров.
 * Он синхронизирует данные с Firebase Firestore и предоставляет пользователю удобный интерфейс для просмотра избранных товаров.
 * </summary>
 */
