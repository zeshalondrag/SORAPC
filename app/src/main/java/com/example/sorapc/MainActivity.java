...
/**
 * Класс MainActivity представляет собой главный экран приложения SORAPC.
 *
 * Основное назначение:
 * - Отображение промо-акций и популярных товаров.
 * - Навигация к категориям каталога товаров.
 * - Интеграция с заголовком (Header) и нижней навигацией (BottomNavigation).
 *
 * Основные функции:
 * - Автоматическая прокрутка ViewPager для промо-акций и популярных товаров.
 * - Загрузка данных о промо-акциях и популярных товарах из Firebase Firestore.
 * - Отображение изображений с использованием Glide.
 * - Обработка кликов для перехода к категориям каталога.
 *
 * Поля:
 * - promotionsPager: ViewPager2 для отображения промо-акций.
 * - topProductsPager: ViewPager2 для отображения популярных товаров.
 * - gamingPcButton: Кнопка для перехода к категории "Игровые ПК".
 * - workstationButton: Кнопка для перехода к категории "Рабочие станции".
 * - gamingPcImage: Изображение для категории "Игровые ПК".
 * - workstationImage: Изображение для категории "Рабочие станции".
 * - db: Экземпляр FirebaseFirestore для работы с базой данных.
 *
 * Вложенные классы:
 * - Promotion: Модель данных для промо-акций.
 * - PromotionAdapter: Адаптер для отображения списка промо-акций.
 * - TopProductAdapter: Адаптер для отображения списка популярных товаров.
 *
 * Особенности:
 * - Интеграция с Firebase Firestore для загрузки данных о товарах.
 * - Использование библиотеки Glide для загрузки изображений.
 * - Автоматическая смена страниц в ViewPager каждые 3.5 секунды.
