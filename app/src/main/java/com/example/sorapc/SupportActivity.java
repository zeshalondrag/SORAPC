...
/**
 * <summary>
 * Класс SupportActivity предоставляет функционал для отправки сообщений в службу поддержки.
 * Реализует проверку авторизации пользователя, формирование уникального номера обращения и отправку сообщения через SMTP.
 * </summary>
 */
